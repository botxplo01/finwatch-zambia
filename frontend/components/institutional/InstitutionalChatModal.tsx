...
export function InstitutionalChatModal({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed z-[70] inset-x-3 bottom-[80px] sm:inset-auto sm:bottom-24 sm:m-0 flex flex-col bg-white dark:bg-zinc-950 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] border border-gray-100 dark:border-zinc-800 transition-all duration-300 animate-in slide-in-from-bottom-4 zoom-in-95",
