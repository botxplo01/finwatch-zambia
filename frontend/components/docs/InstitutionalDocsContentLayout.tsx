...
/**
 * FinWatch Zambia - Institutional Documentation Content Layout
 */
...
import { InstitutionalDocsSidebar } from "./InstitutionalDocsSidebar";
import { InstitutionalDocsSearchModal } from "./InstitutionalDocsSearchModal";
import { cn } from "@/lib/utils";

interface InstitutionalDocsContentLayoutProps {
  children: ReactNode;
  title: string;
  description?: string;
...
export function InstitutionalDocsContentLayout({
  children,
  title,
  description,
  previousSection,
  nextSection,
}: InstitutionalDocsContentLayoutProps) {
