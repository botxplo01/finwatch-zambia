...
/**
 * FinWatch Zambia - Institutional Docs Search Modal
 */
...
import {
  institutionalDocsSearchIndex,
  DocsSearchEntry,
} from "@/lib/institutional-docs-index";

interface InstitutionalDocsSearchModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function InstitutionalDocsSearchModal({
  isOpen,
  onClose,
}: InstitutionalDocsSearchModalProps) {
          ...
          {query.length < 2 ? (
            <div className="py-12 flex flex-col items-center justify-center text-center opacity-40">
              ...
              <p className="text-xs mt-1 italic">
                Find analytics guides, detection logic, and policy reports
              </p>
            </div>
          ) : results.length > 0 ? (
            ...
            <div className="py-12 flex flex-col items-center justify-center text-center opacity-40">
              ...
              <p className="text-sm font-medium">
                No institutional matches found for &quot;{query}&quot;
              </p>
            </div>
          )}
        </div>
