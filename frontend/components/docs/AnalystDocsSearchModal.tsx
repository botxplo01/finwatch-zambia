        ...
        <div className="p-4 sm:p-6 border-b border-zinc-50 dark:border-zinc-800 flex-shrink-0 text-left">
          <div className="relative group">
            ...
            <input
              ref={inputRef}
              type="text"
              placeholder="Search analyst guides..."
              value={query}
              onChange={(e) => setQuery(e.target.value)}
              onKeyDown={handleKeyDown}
              className="w-full h-14 pl-12 pr-12 text-lg bg-zinc-50/50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800 rounded-2xl focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-900/20 transition-all text-zinc-900 dark:text-zinc-100"
            />
            <button
              onClick={onClose}
              ...
              {results.map((result, i) => (
                <Link
                  ...
                  className={cn(
                    ...
                    activeIndex === i
                      ? "bg-blue-50/50 dark:bg-blue-900/10 border-blue-200 dark:border-blue-800/50 shadow-md translate-x-1"
