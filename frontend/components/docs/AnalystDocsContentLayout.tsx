        ...
        <aside className="hidden w-64 flex-shrink-0 lg:block">
          <div className="sticky top-24 max-h-[calc(100vh-8rem)] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-border">
            ...
            >
              ...
              <kbd className="hidden rounded border border-zinc-200 bg-white px-1.5 text-[10px] font-bold text-zinc-400 group-hover:border-blue-200 group-hover:text-blue-600 dark:border-zinc-800 dark:bg-zinc-950 xl:block">
                /
              </kbd>
            </button>
          ...
          <div className="mt-16 flex flex-col gap-4 border-t border-border pt-8 sm:flex-row sm:items-center sm:justify-between">
            {previousSection ? (
              <Link
                ...
                className="group flex flex-col gap-1 rounded-lg border border-border p-4 transition-all hover:border-blue-600/50 hover:bg-blue-50/50 dark:hover:bg-blue-900/5 sm:w-1/2"
              >
                <span className="flex items-center gap-1 text-xs text-muted-foreground">
                  <ArrowLeft className="h-3 w-3" /> Previous
                </span>
                <span className="text-sm font-semibold group-hover:text-blue-600 dark:group-hover:text-blue-400">
            ...
            {nextSection ? (
              <Link
                ...
                className="group flex flex-col items-end gap-1 rounded-lg border border-border p-4 transition-all hover:border-blue-600/50 hover:bg-blue-50/50 dark:hover:bg-blue-900/5 sm:w-1/2"
              >
                <span className="flex items-center gap-1 text-xs text-muted-foreground">
