...
function CompanyCard({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full text-left bg-white/70 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl p-5 hover:border-purple-200 dark:hover:border-purple-800 hover:shadow-md transition-all duration-200 group shadow-sm dark:shadow-none"
    >
      {/* Top row */}
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-0.5 leading-none">
                    Manage your SME profiles
                  </p>
                </div>
              </div>
