...
/**
 * FinWatch Zambia - Documentation Landing Page
 *
...
const SEARCH_SUGGESTIONS = [
  "Search documentation, guides, or terms...",
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="w-full relative py-20 px-4 border-b border-border bg-white dark:bg-[#0a0a0a] z-30">
        {/* Animated Background Elements - High Intensity (In separate overflow-hidden container) */}
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-15%] left-[-10%] w-[50%] h-[70%] rounded-full bg-purple-500/60 dark:bg-purple-400/40 blur-[40px] animate-blob-1" />
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40%] h-[40%] rounded-full bg-purple-400/35 dark:bg-purple-300/25 blur-[40px] animate-blob-3" />
        </div>
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl text-zinc-900 dark:text-zinc-100">
            Everything you need to understand and use{" "}
            <span className="text-purple-600">FinWatch Zambia</span>
          </h1>
          ...
          >
            <div className="relative group">
              <input
                ...
                className="w-full h-12 sm:h-14 pl-10 sm:pl-12 pr-4 py-2 sm:py-3 text-sm border border-zinc-200 dark:border-zinc-700 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md text-gray-900 dark:text-zinc-100 rounded-2xl shadow-sm focus:outline-none focus:border-purple-400 focus:ring-4 focus:ring-purple-100 dark:focus:ring-purple-900/20 transition-all relative z-10"
              />
              ...
              <Search
                className="absolute left-3.5 sm:left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-zinc-500 group-focus-within:text-purple-600 transition-colors z-30 pointer-events-none"
                size={16}
              />
            </div>
            ...
            {showResults && (
              <div className="absolute top-[calc(100%+0.75rem)] left-0 right-0 z-[100] rounded-[1.5rem] border border-zinc-100 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300 overflow-hidden flex flex-col text-left">
                {results.length > 0 ? (
                  <div className="divide-y divide-zinc-100 dark:divide-zinc-800 overflow-y-auto max-h-[60vh] sm:max-h-[420px] scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-700 scrollbar-track-transparent">
                  ...
                  <div className="flex flex-col items-center justify-center py-10 text-muted-foreground">
                    ...
                    <p className="text-sm">No matching guides found.</p>
                  </div>
                )}
              </div>
            )}
      ...
      <section className="container mx-auto py-12 px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {CARDS.map((card, i) => {
            ...
            // Dynamic color mapping for a vibrant institutional palette
            const colorClasses: Record<string, string> = {
              ...
              rose: "bg-rose-50 text-rose-600 dark:bg-rose-900/20 dark:text-rose-400 group-hover:bg-rose-600",
              ...
              red: "bg-red-50 text-red-600 dark:bg-red-900/20 dark:text-red-400 group-hover:bg-red-600",
            };
        ...
        <div className="rounded-3xl bg-zinc-900 p-8 sm:p-12 dark:bg-purple-900/10 border border-white/5 overflow-hidden relative">
          <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <p className="text-zinc-400 mb-8">
              Check our Frequently Asked Questions or ask our Documentation AI
              Assistant for immediate help.
            </p>
