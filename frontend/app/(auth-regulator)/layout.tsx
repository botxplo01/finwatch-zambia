...
export default function RegulatorAuthLayout({
  ...
  return (
    <div className="flex min-h-screen transition-colors duration-300">
      ...
      <section className="flex w-full flex-col items-center justify-start pt-20 md:pt-32 bg-white dark:bg-zinc-950 px-8 md:w-1/2 md:px-16 transition-colors duration-300 border-r border-gray-50 dark:border-zinc-900">
