...
export interface DocsSearchEntry {
  ...
  route: string; // Full route e.g. \"/sme/docs/financial-concepts#current-ratio"
...
export const docsSearchIndex: DocsSearchEntry[] = [
  // Getting Started
  {
    ...
    route: "/sme/docs/getting-started#what-is-finwatch",
  ...
  },
  {
    ...
    route: "/sme/docs/getting-started#creating-account",
  ...
  },
  {
    ...
    route: "/sme/docs/getting-started#first-prediction",
  ...
  // Understanding Your Results
  {
    ...
    route: "/sme/docs/understanding-results#risk-score",
  ...
  },
  {
    ...
    route: "/sme/docs/understanding-results#shap-chart",
  ...
  },
  {
    ...
    route: "/sme/docs/understanding-results#classification",
  ...
  // Financial Concepts
  {
    ...
    route: "/sme/docs/financial-concepts#current-ratio",
  ...
  },
  {
    ...
    route: "/sme/docs/financial-concepts#debt-to-equity",
  ...
  },
  {
    ...
    route: "/sme/docs/financial-concepts#net-profit-margin",
  ...
  // Submitting Financial Data
  {
    ...
    route: "/sme/docs/submitting-data#manual-entry",
  ...
  },
  {
    ...
    route: "/sme/docs/submitting-data#document-upload",
  ...
  // AI Assistant
  {
    ...
    route: "/sme/docs/ai-assistant#assistant-scope",
  ...
  },
  {
    ...
    route: "/sme/docs/ai-assistant#usage-limits",
  ...
  // Reports
  {
    ...
    route: "/sme/docs/reports#pdf-reports",
  ...
  // Account and Privacy
  {
    ...
    route: "/sme/docs/account-privacy#privacy",
  ...
  },
  {
    ...
    route: "/sme/docs/account-privacy#deletion",
  ...
  // Troubleshooting
  {
    ...
    route: "/sme/docs/troubleshooting#prediction-issues",
  ...
  },
  {
    ...
    route: "/sme/docs/troubleshooting#session-issues",
